...
var randomWithin = function randomWithin(within) {
  return Math.floor(Math.random() * within) + 1;
};

var Drake = function Drake(_ref) {
  var name = _ref.name,
      src = _ref.src,
      x = _ref.x,
      y = _ref.y,
...
var getAnimationClass = function getAnimationClass(index) {
  return 'drake-' + (index % 3 === 0 ? 'wiggle' : index % 2 === 0 ? 'wobble' : 'v-wiggle');
};

var Drakes = function Drakes(_ref2) {
  var drakes = _ref2.drakes;
  return drakes.reduce(function (acc, _ref3, i) {
    var name = _ref3.name,
        src = _ref3.src,
        x = _ref3.x,
        y = _ref3.y,
...
//# sourceMappingURL=/src.5f03ab38.map